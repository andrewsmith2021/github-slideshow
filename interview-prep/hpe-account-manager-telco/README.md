...
| [technical-specs-appendix.md](./technical-specs-appendix.md) | Granular SE-level product specs (kept separate from interview narrative — reference only if it comes up) |
...
| [your-questions.md](./your-questions.md) | Smart questions to ask them, organized by interviewer |
| [90-day-plan.md](./90-day-plan.md) | Draft first-90-days outline you can bring to a "how would you approach this account" conversation |

## The role, in one paragraph

Account Manager – Telco at Hewlett Packard Enterprise (HPE), owning one or more Tier 1 Telco/Cable accounts. You'd work day-to-day with **Bob Parsons** (Enterprise Account Manager at HPE) and report up to **Imran Jafri**, VP of Telcos & Service Providers, North America. Core of the job: own the customer relationship end-to-end, build C-level trust, run cross-functional deal teams, and carry a number — new business + retention/expansion — against HPE's compute, storage, networking (now including Juniper), and AI-infrastructure portfolio.
...
- [ ] Read company-and-role.md
- [ ] Fill in story-bank.md with your own examples
- [ ] Rehearse likely-questions.md out loud (or record yourself)
- [ ] Pick 4-6 questions from your-questions.md per interviewer
- [ ] Sketch 90-day-plan.md talking points
